   ...
   , m_kwinTimer(new QTimer(this))
{
    ...
    QDBusConnection::sessionBus().registerService(QStringLiteral("org.lingmo.Settings"));
...
void Application::invokeDesktopProcess()
{
    ...
    QDBusInterface sessionInterface("org.lingmo.Session", "/Session", "org.lingmo.Session",
